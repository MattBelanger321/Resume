...
%---------------------------------------------------------
  \cventry
    ...
    {OSL Retail Services} % Organization
    {Amherstburg, ON CANADA} % Location
    {August 2020 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Responsible for communicating the functionality of cell phones to individuals with little to no understanding of electronics.}
        \item {Daily exposure to the newest peripheral the market has to offer.}
        \item {Maintaining a part time job as well as my studies has given me excellent time management skills and is a testament to my work ethic in all aspects of my life.}
      \end{cvitems}
    }
